...
function AuthForm(props) {
  ...
  const {email,setEmail,password,setPassword,submitHandler,loading} = props
  ...
  return (
    ...
    <Paper style={styles.paper}>
      <Box sx={{display:'flex',justifyContent:'center'}}>
        <span style={{color:'green'}}>{toggle === "/register" ? <h2>New User? Register Now</h2> : <h1>Login</h1>}</span>
      </Box>
        ...
        <Grid container spacing={2}>
          ...
          <Grid item xs={12}>
           ...
           <Box>
            ...
            <small style={{color:'blue', cursor:'pointer'}}>New User? <b>Register here!</b></small>
           </NavLink>
            }
